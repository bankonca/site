...
*/ ?>								
		<div id="wrapper_bg" class="center" >
			...
			<?php if( get_the_title( $ID ) == "Home" ) { ?>
			<div id="homeboxes">
				<div class="homebox"><a href="/category/video/"><img src="/wp-content/uploads/2014/10/button-videos.jpg" alt="Watch the Videos" /></a></div><?php /*
				<div class="homebox"><a href="https://github.com/bitsquare/bitsquare/releases"><img src="/wp-content/uploads/2014/10/button-download.jpg" alt="Download Bitsquare" /></a></div>*/ ?>
				<div class="homebox"><a href="/community/"><img src="/wp-content/uploads/2014/10/button-community.jpg" alt="Join the Community" /></a></div>
				<div class="homebox"><a href="https://github.com/bitsquare/bitsquare"><img src="/wp-content/uploads/2014/10/button-source-code.jpg" alt="Get Bitsquare Source Code" /></a></div>
				<div class="homebox"><a href="https://bitsquare.io/whitepaper.pdf"><img src="/wp-content/uploads/2014/10/button-whitepaper.jpg" alt="Bitsquare White Paper" /></a></div>
			</div>
			<br style="clear: both;" />
			<?php } ?>
